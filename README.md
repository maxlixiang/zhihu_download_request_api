...
知乎是中文互联网上内容质量非常高的平台，很多答主的文章非常有收藏价值，本程序旨在能自动保存关注的博主的文章。目前本程序仅能支持用户主页下的文章、回答、想法的下载。
对于对方主页上的动态内容的下载，本程序使用的request+beautifulsoup4不支持，应当基于playwright技术进行，不再本程序的功能范围内。
<img width="1014" height="115" alt="image" src="https://github.com/user-attachments/assets/f48ec0ab-ec3b-49e0-a23f-adcf23d04821" />
